...
function Hero() {
  ...
  Passionate about technology and software development, especially in the area of web development.
</Typography>
            ...
            >
              ...
              <Typography variant="subtitle1" sx={TypographyCss}>
                ...
                Dps apartment, Law gate, Near Lpu, phagwara, 144401
              </Typography>
            </Box>
            <Box
              sx={{
